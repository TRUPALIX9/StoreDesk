...
| `verifone-commander-reports.md` | **Commander T-Log / closed daily & shift** — period list, `vtransset` schema, POS gaps |
...
- Product names: StoreDesk / StoreDesk Server / StoreDesk Buddy
