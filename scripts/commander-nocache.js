function ConfigClient(){
  ...
  ConfigClient.__sendStats = sendStats;
  ConfigClient.__moduleName = $intern_4;
  ConfigClient.__errFn = null;
  ConfigClient.__moduleBase = $intern_6;
  ConfigClient.__softPermutationId = $intern_7;
  ConfigClient.__computePropValue = null;
  ConfigClient.__getPropMap = null;
  ConfigClient.__installRunAsyncCode = function(){
  }
  ;
  ConfigClient.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  ConfigClient.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  ConfigClient.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  ConfigClient.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[ConfigClient.__softPermutationId];
  ...
  function installScript(filename){
    ...
    function installCode(code_0){
      ...
      script.src = code_0;
      if (ConfigClient.__errFn) {
        script.onerror = function(){
          ConfigClient.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  ConfigClient.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  ConfigClient.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function processMetas(){
    ...
    ConfigClient.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return ConfigClient.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    ConfigClient.__getPropMap = function(){
      var result = {};
    ...
    ;
    ConfigClient.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = ConfigClient.__getPropMap;
    ...
    ConfigClient.__softPermutationId = softPermutationId;
  ...
  processMetas();
  ConfigClient.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = ConfigClient.__moduleBase;
...
ConfigClient.succeeded = ConfigClient();
if (!/loaded|complete/.test(document.readyState)) {
  document.write('<script src="ConfigClient/loadScriptTagFiles.js"></script>');
}
