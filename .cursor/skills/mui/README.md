...
Vendored into StoreDesk from [softaworks/agent-toolkit skills/mui](https://github.com/softaworks/agent-toolkit/tree/main/skills/mui).

Used with **`storedesk-ui`** for product layout. StoreDesk Electron currently ships `@mui/material` ^6.4 — use MUI MCP for installed-version APIs; keep v7 notes in mind for upgrades.

---

A comprehensive skill for working with Material-UI components, styling, and best practices in React applications.
