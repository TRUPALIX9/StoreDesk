...
Vendored into StoreDesk from [softaworks/agent-toolkit skills/react-dev](https://github.com/softaworks/agent-toolkit/tree/main/skills/react-dev).

StoreDesk Electron uses React 19 + React Router v7 + TanStack Query + MUI. Prefer client patterns; ignore Server Components / Server Actions unless explicitly building a web RSC app. Pair with `.cursor/skills/mui/` and `.cursor/skills/storedesk-ui/` for UI work.
